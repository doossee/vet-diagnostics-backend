...
async function main() {
  ...
  const animalTypes = [
    {
      ...
      children: [
        ...
        {
          ru: 'Мелкий рогатый скот',
          uz: 'Mayda shoxli hayvonlar',
          children: [
            {
              ru: 'Овца',
              uz: "Qo'y",
              breeds: [
                { ru: 'Меринос', uz: 'Merinos' },
                { ru: 'Каракульская порода', uz: 'Karakul' },
                { ru: 'Романовская порода', uz: 'Romanov' },
                { ru: 'Гиссарская порода', uz: 'Gissar' },
                { ru: 'Эдильбаевская порода', uz: 'Edilbay' },
                { ru: 'Дорсет', uz: 'Dorset' },
                { ru: 'Саффолк', uz: 'Suffolk' },
                { ru: 'Авасси', uz: 'Awassi' },
                { ru: 'Тексель', uz: 'Texel' },
                { ru: 'Гемпшир', uz: 'Hampshire' },
                { ru: 'Валахская порода', uz: 'Valaxiya' },
                { ru: 'Карабахская порода', uz: 'Karabakh' },
                { ru: 'Шевиот', uz: 'Cheviot' },
                { ru: 'Дорпер', uz: 'Dorper' },
              ],
              colors: [
                { ru: 'Белый', uz: 'Oq' },
                ...
                { ru: 'Серый', uz: 'Kulrang' },
                { ru: 'Жёлтый', uz: 'Sariq' },
                { ru: 'Тёмный', uz: 'Qoramtir' },
                { ru: 'Белый с чёрным', uz: 'Oq-qora' },
                { ru: 'Коричнево-чёрный', uz: 'Jigarrang-qora' },
                { ru: 'Серо-чёрный', uz: 'Kulrang-qora' },
                { ru: 'Жёлто-коричневый', uz: 'Sariq-jigarrang' },
              ],
            },
            {
              ru: 'Коза',
              uz: 'Echki',
              breeds: [
                { ru: 'Зааненская порода', uz: 'Zaanen' },
                { ru: 'Тоггенбургская порода', uz: 'Toggenburg' },
                { ru: 'Альпийская порода', uz: 'Alpin' },
                { ru: 'Нубийская порода', uz: 'Nubian' },
                { ru: 'Ла-Манча', uz: 'La-Mancha' },
                { ru: 'Бурская порода', uz: 'Boer' },
                { ru: 'Кико', uz: 'Kiko' },
                { ru: 'Испанская порода', uz: 'Spanish' },
                { ru: 'Ангорская коза', uz: 'Angora' },
                { ru: 'Кашмирская коза', uz: 'Kashmir' },
                { ru: 'Узбекская чёрная коза', uz: "O'zbekiston qora echkisi" },
                { ru: 'Узбекская пуховая коза', uz: "O'zbekiston mo'ynali echkisi" },
                { ru: 'Киргизская горная коза', uz: "Qirg'iz tog' echkisi" },
                { ru: 'Таджикская горная коза', uz: "Tojik tog' echkisi" },
                { ru: 'Сирийская коза', uz: 'Suriyalik echki' },
                { ru: 'Мархур', uz: 'Markhor' },
                { ru: 'Битальская порода', uz: 'Beetal' },
                { ru: 'Джамнапари', uz: 'Jamnapari' },
                { ru: 'Сирохийская порода', uz: 'Sirohi' },
                { ru: 'Барбарийская порода', uz: 'Barbari' },
              ],
              colors: [
                { ru: 'Белый', uz: 'Oq' },
                { ru: 'Чёрный', uz: 'Qora' },
                { ru: 'Коричневый', uz: 'Jigarrang' },
                { ru: 'Серый', uz: 'Kulrang' },
                { ru: 'Красновато-коричневый', uz: "Qizg'ish-jigarrang" },
                { ru: 'Белый с чёрным', uz: 'Oq-qora' },
                { ru: 'Золотистый', uz: 'Oltin' },
                { ru: 'Пепельный', uz: "Bo'r rang" },
              ],
            },
          ],
        },
          ...
          children: [
            {
              ...
              uz: 'Bir o`rkachli',
              breeds: [
                { ru: 'Афганская порода', uz: "Afg'on tuya zoti" },
                { ru: 'Арабская порода', uz: 'Arab tuya zoti' },
                { ru: 'Сомалийская порода', uz: 'Somali tuya zoti' },
                { ru: 'Индийская порода', uz: 'Hind tuya zoti' },
                { ru: 'Пакистанская порода', uz: 'Pokiston tuya zoti' },
                { ru: 'Суданская порода', uz: 'Sudan tuya zoti' },
                { ru: 'Иранская порода', uz: 'Eron tuya zoti' },
                { ru: 'Туркменская порода', uz: 'Turkman tuya zoti' },
                { ru: 'Белуджистанская порода', uz: 'Balujiston tuya zoti' },
                { ru: 'Магрибская порода', uz: "Mag'rib tuya zoti" },
              ],
              colors: [
                { ru: 'Белый', uz: 'Oq' },
                { ru: 'Желтоватый', uz: "Sarg'ish" },
                { ru: 'Коричневый', uz: 'Jigarrang' },
                { ru: 'Красноватый', uz: "Qizg'ish" },
                { ru: 'Чёрный', uz: 'Qora' },
                { ru: 'Серый', uz: 'Kulrang' },
                { ru: 'Бурый', uz: "Qo'ng'ir" },
              ],
            },
            {
              ru: 'Двугорбые',
              uz: 'Ikki o`rkachli',
              breeds: [
                { ru: 'Казахстанская порода', uz: "Qozog'iston tuya zoti" },
                { ru: 'Монгольская порода', uz: 'Mongol tuya zoti' },
                { ru: 'Иранская порода', uz: 'Eron tuya zoti' },
                { ru: 'Китайская порода', uz: 'Xitoy tuya zoti' },
                { ru: 'Туркменская порода', uz: 'Turkman tuya zoti' },
                { ru: 'Узбекская порода', uz: "O'zbekiston tuya zoti" },
                { ru: 'Каракалпакская порода', uz: 'Qoraqalpoq tuya zoti' },
              ],
              colors: [
                { ru: 'Белый', uz: 'Oq' },
                { ru: 'Желтоватый', uz: "Sarg'ish" },
        ...
        },
        {
          ...
          children: [],
          breeds: [
            { ru: 'Арабская лошадь', uz: 'Arab oti' },
            { ru: 'Английская скаковая', uz: 'Ingliz chopard oti' },
            { ru: 'Орловский рысак', uz: "Orlov yo'rg'asi" },
            { ru: 'Донская лошадь', uz: 'Don oti' },
            { ru: 'Казахстанская лошадь', uz: "Qozog'iston oti" },
            { ru: 'Карабаирская лошадь', uz: 'Qorabair oti' },
            { ru: 'Ахалтекинская лошадь', uz: 'Achal-tekinskiy oti' },
            { ru: 'Будённовская лошадь', uz: 'Budennovsk oti' },
            { ru: 'Кабардинская лошадь', uz: 'Kabardin oti' },
            { ru: 'Киргизская лошадь', uz: "Qirg'iz oti" },
            { ru: 'Узбекская лошадь', uz: "O'zbek oti" },
            { ru: 'Монгольская лошадь', uz: "Mo'g'ul oti" },
            { ru: 'Фризская лошадь', uz: 'Friz oti' },
            { ru: 'Шетландский пони', uz: 'Shetland poni' },
            { ru: 'Гафлингер', uz: 'Haflinger' },
            { ru: 'Першерон', uz: 'Percheron' },
            { ru: 'Арденская лошадь', uz: 'Arden oti' },
            { ru: 'Торийская лошадь', uz: 'Tori oti' },
            { ru: 'Тракененская лошадь', uz: 'Trakenen oti' },
            { ru: 'Липицанская лошадь', uz: 'Lipitsian oti' },
          ],
          colors: [
            { ru: 'Чёрный', uz: 'Qora' },
            { ru: 'Белый', uz: 'Oq' },
        ...
        },
        {
          ...
          children: [],
          breeds: [
            { ru: 'Узбекский осёл', uz: "O'zbekiston eshagi" },
            { ru: 'Каракалпакский осёл', uz: 'Qoraqalpoq eshagi' },
            { ru: 'Туркменский осёл', uz: 'Turkman eshagi' },
            { ru: 'Таджикский осёл', uz: 'Tojik eshagi' },
            { ru: 'Киргизский осёл', uz: "Qirg'iz eshagi" },
            { ru: 'Китайский осёл', uz: 'Xitoy eshagi' },
            { ru: 'Сомалийский осёл', uz: 'Somali eshagi' },
            { ru: 'Нубийский осёл', uz: 'Nubian eshagi' },
            { ru: 'Андалузский осёл', uz: 'Andalusiya eshagi' },
            { ru: 'Каталонский осёл', uz: 'Kataloniya eshagi' },
            { ru: 'Пуату осёл', uz: 'Poitou eshagi' },
            { ru: 'Американский мини-осёл', uz: 'Amerika mini eshagi' },
          ],
          colors: [
            { ru: 'Белый', uz: 'Oq' },
            { ru: 'Чёрный', uz: 'Qora' },
            ...
            { ru: 'Бурый', uz: "Qo'ng'ir" },
            { ru: 'Красновато-коричневый', uz: "Qizg'ish-jigarrang" },
            { ru: 'Белый с коричневым', uz: 'Oq-jigarrang aralash' },
          ],
        },
        {
          ru: 'Зебры',
          ...
          children: [],
          breeds: [
            { ru: 'Равнинная зебра', uz: 'Tekislik zebrasi' },
            { ru: 'Зебра Греви', uz: 'Grevi zebrasi' },
            { ru: 'Горная зебра', uz: "Tog' zebrasi" },
            { ru: 'Зебра Гранта', uz: 'Grant zebrasi' },
            { ru: 'Зебра Чапмана', uz: 'Chapman zebrasi' },
            { ru: 'Горная зебра Хартмана', uz: "Hartmann tog' zebrasi" },
          ],
          colors: [
            { ru: 'Белый с чёрным', uz: 'Oq-qora' },
            { ru: 'Белый с коричневым', uz: 'Oq-jigarrang' },
            { ru: 'Чёрный с коричневым', uz: 'Qora-jigarrang' },
            { ru: 'Белый с серым', uz: 'Oq-kulrang' },
            { ru: 'Белый с желтоватым', uz: "Oq-sarg'ish" },
          ],
        },
        {
          ru: 'Свиньи',
          ...
          children: [],
          breeds: [
            { ru: 'Узбекская свинья', uz: "O'zbekiston cho'chqasi" },
            { ru: 'Крупная белая свинья', uz: "Katta oq cho'chqa" },
            { ru: 'Ландрас', uz: 'Landras' },
            { ru: 'Дюрок', uz: 'Durok' },
            { ru: 'Гемпшир', uz: 'Hampshire' },
            { ru: 'Йоркшир', uz: 'Yorshir' },
            { ru: 'Беркшир', uz: 'Berkshir' },
            { ru: 'Эстонский бекон', uz: 'Estoniya bekoni' },
            { ru: 'Латвийская белая свинья', uz: "Latviya oq cho'chqasi" },
            { ru: 'Украинская порода', uz: "Ukrainaning cho'chqa zoti" },
            { ru: 'Белорусская белая', uz: "Belorus oq cho'chqasi" },
            { ru: 'Вьетнамская вислобрюхая', uz: "Vyetnam vislobryux cho'chqasi" },
            { ru: 'Пьетрен', uz: 'Pietren' },
            { ru: 'Тамворт', uz: 'Tamvort' },
            { ru: 'Мангалица', uz: 'Mangalitsa' },
          ],
          colors: [
            { ru: 'Белый', uz: 'Oq' },
            { ru: 'Чёрный', uz: 'Qora' },
            { ru: 'Коричневый', uz: 'Jigarrang' },
            { ru: 'Красно-коричневый', uz: 'Qizil-jigarrang' },
            { ru: 'Серый', uz: 'Kulrang' },
            { ru: 'Смешанный', uz: 'Aralash' },
          ],
        },
      ],
    },
    {
      ru: 'Мелкие домашние животные',
      uz: 'Mayda uy hayvonlari',
      children: [
        {
          ru: 'Собака',
          uz: 'It',
          breeds: [
            { ru: 'Чихуахуа', uz: 'Chihuahua' },
            { ru: 'Померанский шпиц', uz: 'Pomeranian' },
            { ru: 'Мальтийская болонка', uz: 'Maltese' },
            { ru: 'Ши-тцу', uz: 'Shih Tzu' },
            { ru: 'Пекинес', uz: 'Pekingese' },
            { ru: 'Лхаса апсо', uz: 'Lhasa Apso' },
            { ru: 'Йоркширский терьер', uz: 'Yorkshire Terrier' },
            { ru: 'Бишон фризе', uz: 'Bichon Frise' },
            { ru: 'Кавалер Кинг Чарльз', uz: 'Cavalier King Charles Spaniel' },
            { ru: 'Французский бульдог', uz: 'French Bulldog' },
            { ru: 'Бостон-терьер', uz: 'Boston Terrier' },
            { ru: 'Гаванская собака', uz: 'Havanese' },
            { ru: 'Той-пудель', uz: 'Toy Poodle' },
            { ru: 'Итальянская борзая', uz: 'Italian Greyhound' },
            { ru: 'Папийон', uz: 'Papillon' },
          ],
          colors: [
            { ru: 'Белый', uz: 'Oq' },
            { ru: 'Чёрный', uz: 'Qora' },
        ...
        },
        {
          ...
          uz: 'Mushuk',
          breeds: [
            { ru: 'Персидская кошка', uz: 'Pers mushuk' },
            { ru: 'Сфинкс', uz: 'Sphinx' },
            { ru: 'Сиамская кошка', uz: 'Siamese' },
            { ru: 'Мейн-кун', uz: 'Maine Coon' },
            { ru: 'Британская короткошерстная', uz: 'British Shorthair' },
            { ru: 'Шотландская вислоухая', uz: 'Scottish Fold' },
            { ru: 'Рэгдолл', uz: 'Ragdoll' },
            { ru: 'Бенгальская кошка', uz: 'Bengal' },
            { ru: 'Абиссинская кошка', uz: 'Abyssinian' },
            { ru: 'Русская голубая', uz: 'Russian Blue' },
            { ru: 'Норвежская лесная', uz: 'Norwegian Forest Cat' },
            { ru: 'Восточная короткошерстная', uz: 'Oriental Shorthair' },
            { ru: 'Турецкая ангора', uz: 'Turkish Angora' },
            { ru: 'Бурманская кошка', uz: 'Burmese' },
            { ru: 'Корниш-рекс', uz: 'Cornish Rex' },
          ],
          colors: [
            { ru: 'Белый', uz: 'Oq' },
            { ru: 'Чёрный', uz: 'Qora' },
            ...
            { ru: 'Жёлтоватый', uz: "Sarg'ish" },
            { ru: 'Голубой', uz: 'Moviy' },
            { ru: 'Пёстрый', uz: 'Aralash' },
            { ru: 'Бежевый', uz: 'Bej' },
            { ru: 'Шоколадный', uz: 'Shokolad rang' },
            { ru: 'Линкс', uz: 'Lynx' },
            { ru: 'Табби', uz: 'Tabby' },
          ],
        },
    ...
    },
    {
      ...
      children: [],
      breeds: [
        { ru: 'Корниш', uz: 'Cornish' },
        { ru: 'Плимутрок', uz: 'Plymouth Rock' },
        { ru: 'Орпингтон', uz: 'Orpington' },
        { ru: 'Брама', uz: 'Brahma' },
        { ru: 'Сассекс', uz: 'Sussex' },
        { ru: 'Виандот', uz: 'Wyandotte' },
        { ru: 'Маран', uz: 'Maran' },
        { ru: 'Силки', uz: 'Silkie' },
        { ru: 'Польская', uz: 'Polish' },
        { ru: 'Бантам', uz: 'Bantam' },
        { ru: 'Себрайт', uz: 'Sebright' },
        { ru: 'Леггорн', uz: 'Leghorn' },
        { ru: 'Минорка', uz: 'Minorca' },
        { ru: 'Анкона', uz: 'Ancona' },
        { ru: 'Гамбург', uz: 'Hamburg' },
      ],
      colors: [
        { ru: 'Белый', uz: 'Oq' },
        { ru: 'Чёрный', uz: 'Qora' },
    ...
    },
    {
      ...
      children: [],
      breeds: [
        { ru: 'Итальянская', uz: 'Italiyan' },
        { ru: 'Карниольская', uz: 'Carniolan' },
        { ru: 'Кавказская', uz: 'Kavkaz' },
        { ru: 'Евро-патагонская', uz: 'Yevro-patagonian' },
        { ru: 'Восточная', uz: 'Sharqiy' },
        { ru: 'Африканская', uz: 'Afrika' },
        { ru: 'Дикая тропическая', uz: 'Yovvoyi tropik' },
        { ru: 'Дикая малая', uz: 'Yovvoyi kichik' },
        { ru: 'Мини / местная', uz: 'Mini / mahalliy' },
      ],
      colors: [
        { ru: 'Жёлтый', uz: 'Sariq' },
        { ru: 'Красно-жёлтый', uz: 'Qizil-sariq' },
        { ru: 'Коричневый', uz: 'Jigarrang' },
        { ru: 'Чёрный', uz: 'Qora' },
        { ru: 'Жёлто-чёрный', uz: 'Sariq-qora chiziqli' },
        { ru: 'Золотистый', uz: 'Oltin rang' },
        { ru: 'Медовый', uz: 'Asal rang' },
      ],
    },
  ];
  ...
  const urineColorsData = [
    ...
    [
      { ru: "Тёмно-жёлтый", uz: "To'q sariq", nv: 0 },
      { ru: 'Красный', uz: 'Qizil', nv: 1 },
      { ru: 'Розовый', uz: 'Pushti', nv: 2 },
      { ru: 'Коричневый', uz: 'Jigarrang', nv: 3 },
    ],
    // Horses
    [
      { ru: "Тёмно-жёлтый", uz: "To'q sariq", nv: 0 },
      { ru: 'Коричневый', uz: 'Jigarrang', nv: 1 },
      { ru: 'Красный', uz: 'Qizil', nv: 2 },
      { ru: 'Молочного цвета', uz: 'Sut rang', nv: 3 },
    ],
    // Pigs
    [
      { ru: 'Светло-жёлтый', uz: 'Och sariq', nv: 0 },
      { ru: 'Коричневый', uz: 'Jigarrang', nv: 1 },
      { ru: 'Красный', uz: 'Qizil', nv: 2 },
      { ru: 'Молочный', uz: 'Sut rang', nv: 3 },
    ],
  ];
