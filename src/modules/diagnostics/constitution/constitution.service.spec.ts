...
describe('ConstitutionService', () => {
  ...
  describe('create', () => {
    it('should create a record', async () => {
      ...
      mockPrismaService.constitution.create.mockResolvedValue(mock);
  ...
  describe('findOne', () => {
    it('should return a record', async () => {
      ...
      mockPrismaService.constitution.findUniqueOrThrow.mockResolvedValue(mock);
  ...
  describe('update', () => {
    it('should update a record', async () => {
      ...
      const mock = { id: 'uuid', ...dto };
      mockPrismaService.constitution.update.mockResolvedValue(mock);
  ...
  describe('delete', () => {
    it('should delete a record', async () => {
      const mock = { id: 'uuid' };
      mockPrismaService.constitution.delete.mockResolvedValue(mock);
  ...
  describe('importFromExcel', () => {
    it('should import rows successfully', async () => {
      mockPrismaService.constitution.create.mockResolvedValue({});
