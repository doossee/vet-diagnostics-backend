...
import { SkinHumidityEntity, PaginatedSkinHumidityEntity } from './entities';
import { IsAuthenticated } from 'src/shared/decorators';

@IsAuthenticated()
@ApiTags('skin-humidities')
@Controller('skin-humidities')
export class SkinHumidityController {
  constructor(
    private readonly service: SkinHumidityService,
  ...
  @Post()
  async create(@Body() data: CreateSkinHumidityDto) {
  ...
  @ApiOkResponse({
    type: PaginatedSkinHumidityEntity,
    description: 'Records retrieved successfully',
  })
  @Get()
  async findAll(@Query() query: SkinHumidityQueryParamsDto) {
  ...
  @Header('Content-Disposition', 'attachment; filename="влажность-кожи-шаблон.xlsx"')
  @Get('template')
  ...
  async update(
    ...
    @Body() data: UpdateSkinHumidityDto,
  ) {
