...
describe('FecesColorController', () => {
  let controller: FecesColorController;
  ...
  beforeEach(async () => {
    ...
    controller = module.get<FecesColorController>(FecesColorController);
