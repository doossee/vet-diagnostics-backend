...
describe('ObesityTypeService', () => {
  let service: ObesityTypeService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<ObesityTypeService>(ObesityTypeService);
  });
  ...
  describe('create', () => {
    it('should create a record', async () => {
      ...
      mockPrismaService.obesityType.create.mockResolvedValue(mock);
  ...
  describe('findOne', () => {
    it('should return a record', async () => {
      ...
      mockPrismaService.obesityType.findUniqueOrThrow.mockResolvedValue(mock);
  ...
  describe('update', () => {
    it('should update a record', async () => {
      ...
      const mock = { id: 'uuid', ...dto };
      mockPrismaService.obesityType.update.mockResolvedValue(mock);
  ...
  describe('delete', () => {
    it('should delete a record', async () => {
      const mock = { id: 'uuid' };
      mockPrismaService.obesityType.delete.mockResolvedValue(mock);
  ...
  describe('importFromExcel', () => {
    it('should import rows successfully', async () => {
      mockPrismaService.obesityType.create.mockResolvedValue({});
    ...
    it('should collect errors for failed rows', async () => {
      mockPrismaService.obesityType.create.mockRejectedValue(new Error('duplicate'));
      const result = await service.importFromExcel([
        { name_ru: 'Тест', name_uz: 'Test', numericValue: 1 },
      ]);
