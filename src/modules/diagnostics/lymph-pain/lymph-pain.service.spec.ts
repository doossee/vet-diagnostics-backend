...
describe('LymphPainService', () => {
  let service: LymphPainService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<LymphPainService>(LymphPainService);
  });
  ...
  describe('create', () => {
    it('should create a record', async () => {
      ...
      mockPrismaService.lymphPain.create.mockResolvedValue(mock);
  ...
  describe('findOne', () => {
    it('should return a record', async () => {
      ...
      mockPrismaService.lymphPain.findUniqueOrThrow.mockResolvedValue(mock);
  ...
  describe('update', () => {
    it('should update a record', async () => {
      ...
      const mock = { id: 'uuid', ...dto };
      mockPrismaService.lymphPain.update.mockResolvedValue(mock);
  ...
  describe('delete', () => {
    it('should delete a record', async () => {
      const mock = { id: 'uuid' };
      mockPrismaService.lymphPain.delete.mockResolvedValue(mock);
  ...
  describe('importFromExcel', () => {
    it('should import rows successfully', async () => {
      mockPrismaService.lymphPain.create.mockResolvedValue({});
    ...
    it('should collect errors for failed rows', async () => {
      mockPrismaService.lymphPain.create.mockRejectedValue(new Error('duplicate'));
      const result = await service.importFromExcel([
        { name_ru: 'Тест', name_uz: 'Test', numericValue: 1 },
      ]);
