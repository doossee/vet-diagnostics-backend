...
describe('LymphSurfaceService', () => {
  let service: LymphSurfaceService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<LymphSurfaceService>(LymphSurfaceService);
  });
  ...
  describe('create', () => {
    it('should create a record', async () => {
      ...
      mockPrismaService.lymphSurface.create.mockResolvedValue(mock);
  ...
  describe('findOne', () => {
    it('should return a record', async () => {
      ...
      mockPrismaService.lymphSurface.findUniqueOrThrow.mockResolvedValue(mock);
  ...
  describe('update', () => {
    it('should update a record', async () => {
      ...
      const mock = { id: 'uuid', ...dto };
      mockPrismaService.lymphSurface.update.mockResolvedValue(mock);
  ...
  describe('delete', () => {
    it('should delete a record', async () => {
      const mock = { id: 'uuid' };
      mockPrismaService.lymphSurface.delete.mockResolvedValue(mock);
  ...
  describe('importFromExcel', () => {
    it('should import rows successfully', async () => {
      mockPrismaService.lymphSurface.create.mockResolvedValue({});
    ...
    it('should collect errors for failed rows', async () => {
      mockPrismaService.lymphSurface.create.mockRejectedValue(new Error('duplicate'));
      const result = await service.importFromExcel([
        { name_ru: 'Тест', name_uz: 'Test', numericValue: 1 },
      ]);
