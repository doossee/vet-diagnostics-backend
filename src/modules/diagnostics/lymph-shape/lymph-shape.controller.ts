...
import { LymphShapeEntity, PaginatedLymphShapeEntity } from './entities';
import { IsAuthenticated } from 'src/shared/decorators';

@IsAuthenticated()
@ApiTags('lymph-shapes')
@Controller('lymph-shapes')
export class LymphShapeController {
  constructor(
    private readonly service: LymphShapeService,
  ...
  @Post()
  async create(@Body() data: CreateLymphShapeDto) {
  ...
  @ApiOkResponse({
    type: PaginatedLymphShapeEntity,
    description: 'Records retrieved successfully',
  })
  @Get()
  async findAll(@Query() query: LymphShapeQueryParamsDto) {
  ...
  @Header('Content-Disposition', 'attachment; filename="форма-лимфоузлов-шаблон.xlsx"')
  @Get('template')
