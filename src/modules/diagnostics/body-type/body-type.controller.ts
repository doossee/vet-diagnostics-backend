...
import { BodyTypeEntity, PaginatedBodyTypeEntity } from './entities';
...
export class BodyTypeController {
  constructor(
    private readonly service: BodyTypeService,
  ...
  @Post()
  async create(@Body() data: CreateBodyTypeDto) {
  ...
  @ApiOkResponse({
    type: PaginatedBodyTypeEntity,
    description: 'Records retrieved successfully',
  })
  @Get()
  async findAll(@Query() query: BodyTypeQueryParamsDto) {
  ...
  @Header('Content-Disposition', 'attachment; filename="тип-телосложения-шаблон.xlsx"')
  @Get('template')
