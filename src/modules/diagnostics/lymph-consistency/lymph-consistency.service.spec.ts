...
describe('LymphConsistencyService', () => {
  let service: LymphConsistencyService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        LymphConsistencyService,
        { provide: PrismaService, useValue: mockPrismaService },
        { provide: PaginationService, useValue: mockPaginationService },
      ],
    }).compile();
    service = module.get<LymphConsistencyService>(LymphConsistencyService);
  });
  ...
  describe('create', () => {
    it('should create a record', async () => {
      ...
      mockPrismaService.lymphConsistency.create.mockResolvedValue(mock);
  ...
  describe('update', () => {
    it('should update a record', async () => {
      ...
      const mock = { id: 'uuid', ...dto };
      mockPrismaService.lymphConsistency.update.mockResolvedValue(mock);
  ...
  describe('delete', () => {
    it('should delete a record', async () => {
      const mock = { id: 'uuid' };
      mockPrismaService.lymphConsistency.delete.mockResolvedValue(mock);
  ...
  describe('importFromExcel', () => {
    it('should import rows successfully', async () => {
      mockPrismaService.lymphConsistency.create.mockResolvedValue({});
