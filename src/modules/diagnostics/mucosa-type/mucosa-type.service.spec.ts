...
describe('MucosaTypeService', () => {
  let service: MucosaTypeService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<MucosaTypeService>(MucosaTypeService);
  });
  ...
  describe('create', () => {
    it('should create a record', async () => {
      ...
      mockPrismaService.mucosaType.create.mockResolvedValue(mock);
  ...
  describe('findOne', () => {
    it('should return a record', async () => {
      ...
      mockPrismaService.mucosaType.findUniqueOrThrow.mockResolvedValue(mock);
  ...
  describe('update', () => {
    it('should update a record', async () => {
      ...
      const mock = { id: 'uuid', ...dto };
      mockPrismaService.mucosaType.update.mockResolvedValue(mock);
  ...
  describe('delete', () => {
    it('should delete a record', async () => {
      const mock = { id: 'uuid' };
      mockPrismaService.mucosaType.delete.mockResolvedValue(mock);
  ...
  describe('importFromExcel', () => {
    it('should import rows successfully', async () => {
      mockPrismaService.mucosaType.create.mockResolvedValue({});
    ...
    it('should collect errors for failed rows', async () => {
      mockPrismaService.mucosaType.create.mockRejectedValue(new Error('duplicate'));
      const result = await service.importFromExcel([
        { name_ru: 'Тест', name_uz: 'Test', numericValue: 1 },
      ]);
