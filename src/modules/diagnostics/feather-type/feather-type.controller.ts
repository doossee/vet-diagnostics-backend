...
import { FeatherTypeEntity, PaginatedFeatherTypeEntity } from './entities';
import { IsAuthenticated } from 'src/shared/decorators';

@IsAuthenticated()
@ApiTags('feather-types')
@Controller('feather-types')
export class FeatherTypeController {
  constructor(
    private readonly service: FeatherTypeService,
  ...
  @Post()
  async create(@Body() data: CreateFeatherTypeDto) {
  ...
  @ApiOkResponse({
    type: PaginatedFeatherTypeEntity,
    description: 'Records retrieved successfully',
  })
  @Get()
  async findAll(@Query() query: FeatherTypeQueryParamsDto) {
  ...
  @Header('Content-Disposition', 'attachment; filename="тип-перьев-шаблон.xlsx"')
  @Get('template')
  ...
  async update(
    ...
    @Body() data: UpdateFeatherTypeDto,
  ) {
