...
import { SkinSmellEntity, PaginatedSkinSmellEntity } from './entities';
import { IsAuthenticated } from 'src/shared/decorators';

@IsAuthenticated()
@ApiTags('skin-smells')
@Controller('skin-smells')
export class SkinSmellController {
  constructor(
    private readonly service: SkinSmellService,
  ...
  @Post()
  async create(@Body() data: CreateSkinSmellDto) {
  ...
  @ApiOkResponse({
    type: PaginatedSkinSmellEntity,
    description: 'Records retrieved successfully',
  })
  @Get()
  async findAll(@Query() query: SkinSmellQueryParamsDto) {
  ...
  @Header('Content-Disposition', 'attachment; filename="запах-кожи-шаблон.xlsx"')
  @Get('template')
