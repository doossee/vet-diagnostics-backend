...
describe('AnimalColorController', () => {
  let controller: AnimalColorController;
  ...
  beforeEach(async () => {
    ...
    controller = module.get<AnimalColorController>(AnimalColorController);
